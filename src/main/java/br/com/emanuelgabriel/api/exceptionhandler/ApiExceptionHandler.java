...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(CodigoObjetoRastroNaoEncontrado.class)
	public ResponseEntity<?> regraNegocioException(CodigoObjetoRastroNaoEncontrado ex, WebRequest request) {
